  ...
  return (
     ...
     <div className='w-[40px] h-[40px] rounded-full overflow-hidden flex justify-center
              items-center bg-white  shadow-gray-600 shadow-lg cursor-pointer '>
                ...
                <div ref={scroll} className='w-fit max-w-[500px] px-[20px] py-[5px] bg-[rgb(23,151,194)]
         text-white text-[19px] rounded-tl-none rounded-2xl
          relative left-0  shadow-gray-800 shadow-lg gap-[10px] flex flex-col'>
