        ...
        <div className='w-full absolute bottom-[20px] flex items-center justify-center'>
          ...
          {frontendImage && (
            <img
              src={frontendImage}
              alt=''
              className='w-[80px] absolute bottom-[100px] right-[19%] rounded-lg shadow-gray-700 shadow-lg'
            />
          )}

          <form
            className='w-[95%] lg:w-[70%] h-[60px] bg-[rgb(23,151,194)] dark:bg-slate-900 shadow-gray-400 dark:shadow-black shadow-lg rounded-full flex items-center gap-[20px] px-[20px] relative transition-colors duration-300'
